...
def get_memory_service():
    """Process-wide memory service using VertexAiMemoryBankService when available."""
    ...
    memory_bank_id = (
        ...
        or "8386856993373028352"
    )
    if memory_bank_id:
        from google.adk.memory import VertexAiMemoryBankService

        project = (
            os.environ.get("GOOGLE_CLOUD_PROJECT") or "qwiklabs-gcp-03-90af3d54a148"
        )
        location = (
